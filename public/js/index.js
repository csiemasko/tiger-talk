...
},{"../views/app.vue":34,"moment":27,"vue":31,"vue-google-signin-button":29}],34:[function(require,module,exports){
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"app"},[_c('transition',{attrs:{"name":"modal-show"}},[(!_vm.session.loggedIn)?_c('div',{staticClass:"login"},[_c('modal',{attrs:{"header":"Log In to Tiger Talk"}},[_c('transition-group',{attrs:{"name":"t-login-field"},on:{"enter":_vm.loginEnter}},[_c('div',{key:"1",staticClass:"login-field"},[_c('div',{staticClass:"modal-label"},[_vm._v("User Name")]),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.session.userLogin),expression:"session.userLogin"}],attrs:{"placeholder":"Username"},domProps:{"value":(_vm.session.userLogin)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.session, "userLogin", $event.target.value)}}})]),_c('div',{key:"2",staticClass:"login-field"},[_c('div',{staticClass:"modal-label"},[_vm._v("Password          ")]),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.session.userPass),expression:"session.userPass"}],attrs:{"type":"password","placeholder":"Password"},domProps:{"value":(_vm.session.userPass)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.session, "userPass", $event.target.value)}}})]),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.ui.newUser),expression:"ui.newUser"}],key:"3",staticClass:"login-field"},[_c('div',{staticClass:"modal-label"},[_vm._v("Verify Password          ")]),_c('input',{directives:[{name:"show",rawName:"v-show",value:(_vm.ui.newUser),expression:"ui.newUser"},{name:"model",rawName:"v-model",value:(_vm.session.userPassVerify),expression:"session.userPassVerify"}],attrs:{"type":"password","placeholder":"Verify Password"},domProps:{"value":(_vm.session.userPassVerify)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.session, "userPassVerify", $event.target.value)}}})]),_c('div',{key:"4",staticClass:"login-button",on:{"click":_vm.login}},[_c('i',{staticClass:"fa fa-sign-in"}),_vm._v(_vm._s(_vm.ui.newUser ? 'Create + Sign In' : 'Sign In'))]),_c('gbutton',{key:"5",on:{"glogin":function($event){_vm.googleSignIn($event)}}}),_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.ui.newUser),expression:"!ui.newUser"}],key:"6",staticClass:"login-button",attrs:{"value":"Create Account"},on:{"click":function($event){_vm.ui.newUser = true}}},[_c('i',{staticClass:"fa fa-plus"}),_vm._v("Create Account")])],1)],1)],1):_vm._e()]),_c('transition',{attrs:{"name":"header-enter"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.session.loggedIn),expression:"session.loggedIn"}],staticClass:"header"},[_c('h1',[_vm._v(_vm._s(_vm.ui.title))]),_c('a',{attrs:{"href":"https://github.com/csiemasko/tiger-talk","target":"_blank"}},[_c('i',{staticClass:"fa fa-github"})])])]),_c('transition',{attrs:{"name":"chat-enter"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.session.loggedIn),expression:"session.loggedIn"}],key:"1",staticClass:"chat"},[_c('div',{staticClass:"room"},[_c('transition-group',{attrs:{"name":"show-message"}},_vm._l((_vm.messages),function(m,i){return _c('message',{key:i,attrs:{"user":m.user,"message":m.message}})}))],1),_c('div',{staticClass:"entry"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.entryBox),expression:"entryBox"}],attrs:{"placeholder":"Start Typing..."},domProps:{"value":(_vm.entryBox)},on:{"keyup":function($event){if(!('button' in $event)&&_vm._k($event.keyCode,"enter",13,$event.key)){ return null; }_vm.postMessage($event)},"input":function($event){if($event.target.composing){ return; }_vm.entryBox=$event.target.value}}}),_c('i',{staticClass:"fa fa-paper-plane"})])])]),_c('transition',{attrs:{"name":"users-enter"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.session.loggedIn),expression:"session.loggedIn"}],staticClass:"userlist"},_vm._l((_vm.users),function(u){return _c('user',{attrs:{"user":u}})}))]),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.ui.toastVisible),expression:"ui.toastVisible"}],attrs:{"id":"toast"}},[_vm._v(_vm._s(_vm.ui.toastMessage))])],1)}
...
},{"./gsignin.vue":35,"./message.vue":36,"./modal.vue":37,"./user.vue":38,"axios":1,"vue":31,"vue-hot-reload-api":30,"vueify/lib/insert-css":32}],35:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('g-signin-button',{attrs:{"params":_vm.googleSignInParams},on:{"success":_vm.onSignInSuccess,"error":_vm.onSignInError}},[_c('i',{staticClass:"fa fa-google"}),_vm._v("Sign In With Google    ")])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"axios":1,"vue":31,"vue-hot-reload-api":30}],36:[function(require,module,exports){
...
},{"vue":31,"vue-hot-reload-api":30,"vueify/lib/insert-css":32}],37:[function(require,module,exports){
...
},{"vue":31,"vue-hot-reload-api":30,"vueify/lib/insert-css":32}],38:[function(require,module,exports){
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"user-frame"},[_c('div',{staticClass:"avatar-frame"},[_c('img',{attrs:{"src":_vm.user.avatar,"alt":_vm.user.name}})]),_c('span',{staticClass:"name"},[_vm._v(_vm._s(_vm.user.name))])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"vue":31,"vue-hot-reload-api":30,"vueify/lib/insert-css":32}]},{},[33])
